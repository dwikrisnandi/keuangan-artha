import { LogOut, KeyRound, Shield, Bell, Moon, Smartphone } from 'lucide-react'
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-20 md:pb-0 max-w-4xl">
      <div className="flex flex-col gap-1 mb-2">
        <h2 className="text-text-primary text-xl font-bold tracking-tight">Pengaturan</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <BentoCard colSpan={1} title="Keamanan">
          <div className="flex flex-col h-full justify-between gap-6">
            ...
            <button
              onClick={logout}
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-rose-primary/10 text-rose-primary font-semibold text-sm hover:bg-rose-primary hover:text-white transition-colors"
            >
          ...
          <div className="divide-y divide-glass-border">
            ...
            <div className="flex items-center justify-between py-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-text-primary font-medium text-sm">Mode Gelap (Dark Mode)</h4>
                  <p className="text-text-muted text-xs">Gunakan tema gelap sebagai standar aplikasi</p>
                </div>
              </div>
              {/* Toggle switch (mock) */}
              <div className="w-12 h-6 rounded-full bg-text-primary relative cursor-not-allowed">
                <div className="absolute right-1 top-1 w-4 h-4 rounded-full bg-bg-primary" />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between py-4">
              ...
              {/* Toggle switch (mock) */}
              <div className="w-12 h-6 rounded-full bg-glass-border relative cursor-not-allowed">
